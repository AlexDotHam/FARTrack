...
def local_env_settings():
    ...
    settings.network_path = '/data5/artrack_tiny_224_15_pruning/'   # Where tracking networks are stored.
    ...
    settings.prj_dir = '/home/baiyifan/code/pruning/'
    settings.result_plot_path = '/data5/artrack_tiny_224_15_pruning/'
    settings.results_path = '/data5/artrack_tiny_224_15_pruning/'    # Where to store tracking results
    settings.save_dir = '/data5/artrack_tiny_224_15_pruning/'
