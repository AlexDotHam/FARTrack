...
from lib.models.artrackv2.vit import vit_base_patch16_224, vit_large_patch16_224, vit_tiny_patch16_224
...
def build_artrackv2(cfg, training=True):
 ...
 #   score_decoder = build_score_decoder(cfg, hidden_dim)
  ...
  #      score_decoder,
    ...
    load_from = "/data5/artrack_tiny_224_final/checkpoints/train/artrackv2/artrackv2_tiny_256/ARTrackV2_ep0500.pth.tar"
    checkpoint = torch.load(load_from, map_location="cpu")
    missing_keys, unexpected_keys = model.load_state_dict(checkpoint["net"], strict=False)
    print('Load pretrained model from: ' + load_from)
    #"/data1/artrackv2_tiny_full/checkpoints/train/artrackv2/artrackv2_256_full/ARTrackV2_ep0300.pth.tar"
    return model
