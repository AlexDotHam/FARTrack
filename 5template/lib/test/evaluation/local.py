...
def local_env_settings():
    ...
    settings.network_path = '/data5/artrack_tiny_224_sav_extra_4.5/'   # Where tracking networks are stored.
    ...
    settings.prj_dir = '/home/baiyifan/code/4template/'
    settings.result_plot_path = '/data5/artrack_tiny_224_sav_extra_4.5/'
    settings.results_path = '/data5/artrack_tiny_224_sav_extra_4.5/'    # Where to store tracking results
    settings.save_dir = '/data5/artrack_tiny_224_sav_extra_4.5/'
